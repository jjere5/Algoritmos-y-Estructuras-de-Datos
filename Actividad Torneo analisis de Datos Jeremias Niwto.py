...
# Clasificar según comparación con el promedio
def clasificar_puntaje(p):
    if p < promedio_general:
        return 'Puntaje Bajo'
    elif p == promedio_general:
        return 'Puntaje Medio'
    else:
        return 'Puntaje Alto'

        df['Categoria'] = df['Puntuacion'].apply(clasificar_puntaje)

# Mostrar resumen de categorías
print("\n--- Distribución de Categorías ---")
print(df['Categoria'].value_counts())

# Mostrar tabla con las categorías y puntajes
print("\n--- Participantes y su Categoría ---")
print(df[['First Name', 'Puntuacion', 'Categoria']].sort_values(by='Puntuacion', ascending=False))